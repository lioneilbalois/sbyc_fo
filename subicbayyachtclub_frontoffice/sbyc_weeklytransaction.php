...
<html lang="en">
  <head>
	...
	<script>
		var tables = ["cash", "depslip", "check", "credit", "pr", "bill"];
		...
		$(document).ready(function (){
			...
			$('#date_begin').on('change', function(){
				var start = $(this).val();
				var origDate = new Date($(this).val()), end; 
				...
				$('#tbody_cash').load('tableContent.php', { 
					start, end
				});
			});
		});
		...
		<div class="row">
			<div class="col-md-12">
				<div style="float:right">
				 <h3>Starting Date: <input type="date" value="<?php echo $sel_date; ?>" id="date_begin"></h3> 
				 <h3>Ending Date: <input type="date" id="date_end" disabled></h3>
				 <hr>
				</div>
				<br><br><br><br><br><br><h3>Cash (CA) Transaction <button type="button" class="btn btn-primary" style="float:right;" data-backdrop="static" data-toggle="modal" data-target="#addcaModal">Add</button></h3>
