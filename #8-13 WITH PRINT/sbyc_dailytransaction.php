...
<html lang="en">
  <head>
	...
	<body>
		...
		<!-- hidden ifram to load the page to print -->
		<iframe name="iframe" id="iframe" style="position: absolute; width:0; height:0; border:0;"></iframe>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div style="float:left">
					...
					<button id="print_bt" onclick="print_me();">Print</button>
				</div>
				<div style="float:right; ">
					...
					<br><br>
					<h3 id="showSort"> 
						Date: <input type="text" id="datepicker" onmouseover='datepick_apply();' value=<?php echo $sel_date ?>> 
					</h3>
				</div> <br> <br> <br><br> <hr>
			</div>
		</div>
