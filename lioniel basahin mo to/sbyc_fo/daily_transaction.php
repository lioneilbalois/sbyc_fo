            ...
            <table class="table table-bordered">
                ...
                <tbody id="table_cash">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($amount_cash_row[0] == NULL) { echo "-"; } else {echo number_format($amount_cash_row['0'], 2); $amount_cash = number_format($amount_cash_row['0'], 2);}?>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table table-bordered">
                ...
                <tbody id="table_depslip">
                    ...
                    <tr>
                        ...
                        <td>
                        <?php if($amount_depslip_row[0] == NULL) { echo "-"; } else {echo number_format($amount_depslip_row['0'], 2); $amount_depslip = number_format($amount_depslip_row['0'], 2);}?>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table table-bordered">
                ...
                <tbody id="table_check">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($amount_check_row[0] == NULL) { echo "-"; } else {echo number_format($amount_check_row['0'], 2); $amount_check = number_format($amount_check_row['0'], 2);}?>
                        </td>
                    </tr>
            ...
            <table class="table table-bordered">
                ...
                <tbody id="table_credit">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($amount_credit_row[0] == NULL) { echo "-"; } else {echo number_format($amount_credit_row['0'], 2); $amount_credit = number_format($amount_credit_row['0'], 2);}?>
                        </td>
                    </tr>
            ...
            <table class="table table-bordered">
                ...
                <tbody id="table_pr">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($amount_pr_row[0] == NULL) { echo "-" ; } else {echo number_format($amount_pr_row['0'], 2); $amount_pr = number_format($amount_pr_row['0'], 2);}?>
                        </td>
                    </tr>
            ...
            <div class="col-md-6">
                ...
                <table class="table table-bordered" style="max-width: 65%;" id="amount_summary">
                    <tr>
                        ...
                        <td><?php if($amount_cash_row[0] == NULL) { echo 0 ; } else {echo number_format($amount_cash_row['0'], 2);}?></td>
                    </tr>
                    <tr>
                        <th> <h5>Deplsip Transaction:</h5> </th>
                        <td><?php if($amount_depslip_row[0] == NULL) { echo 0 ; } else {echo number_format($amount_depslip_row['0'], 2);}?></td>
                    </tr>
                    <tr>
                        <th> <h5>Check Transaction:</h5> </th>
                        <td><?php if($amount_check_row[0] == NULL) { echo 0 ; } else {echo number_format($amount_check_row['0'], 2);}?></td>
                    </tr>
                    <tr>
                        <th> <h5>Credit Transaction:</h5> </th>
                        <td><?php if($amount_credit_row[0] == NULL) { echo 0 ; } else {echo number_format($amount_credit_row['0'], 2);}?></td>
                    </tr>
                    <tr>
                        <th> <h5>PR Transaction:</h5> </th>
                        <td><?php if($amount_pr_row[0] == NULL) { echo 0 ; } else {echo number_format($amount_pr_row['0'], 2);}?></td>
                    </tr>
                    <tr>
